...
const Reports = () => {
  ...
  return (
    <Space direction="vertical" size="large" style={{ width: '100%' }}>
      <div>
        <Typography.Title level={2} style={{ marginBottom: 0 }}>Reportes ROS</Typography.Title>
        <Typography.Text type="secondary">Generacion y exportacion de reportes de operaciones sospechosas.</Typography.Text>
      </div>
